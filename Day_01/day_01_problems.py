...
def format_data(in_file: TextIOWrapper) -> list[list[str]]:
    ...
    Returns:
        list[list[str]]: input data as list[list[str]]
    """

    return [x.split("\n") for x in in_file.read().strip().split("\n\n")]


def find_highest_calorie_count(dat: list[list[str]]) -> int:
    """Return max sum from input lists"

    Args:
        dat (list[list[str]]): list of lists of numbers as str

    Returns:
        int: max sum from input lists
    """
...
def find_highest_three_calorie_counts(dat: list[list[str]]) -> int:
    """Return sum of top 3 sums from input lists

    Args:
        dat (list[list[str]]): list of lists of numbers as str

    Returns:
        int: sum of top 3 sums from input lists
    """
...
def sum_top_n_highest(dat: list[list[str]], n: int = inf) -> int:
    ...
    Returns:
        int: sum of top n sums from input lists
    """
